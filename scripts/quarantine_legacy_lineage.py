...
def build_legacy_lineage_quarantine(data_root: Path) -> dict:
    ...
    for line_no, row in enumerate(metas, 1):
        ...
        indexed.append({
            ...
            "reason_codes": reasons or ["legacy_pre_transactional_writer"],
    ...
    report = {
        ...
        "note": ("93 historical meta rows are observations, not independent run IDs; "
                 "new collection uses transactional run manifests and immutable IDs."),
    }
